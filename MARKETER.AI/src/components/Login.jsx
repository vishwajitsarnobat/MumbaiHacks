        ...
        <form onSubmit={handleSubmit(login)} className="mt-8">
          <div className="space-y-5">
            ...
            <Input
              ...
              className="w-full px-4 py-3 rounded-lg focus:black focus:ring-2 focus:ring-blue-200 text-zinc-900 bg-white transition-colors"
            />

            <Button
              type="submit"
              className="w-full px-4 py-3 text-white bg-black hover:bg-black rounded-lg font-medium transition-colors focus:ring-2 focus:black focus:ring-offset-2 align-middle"
            >
              Sign in
            </Button>
          </div>
